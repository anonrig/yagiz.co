...
![WHATWG URL Parser](@/assets/content/whatwg-url-parser-slide-1.png)

![Wanted: Reimplement WHATWG URL Parser in WASM](@/assets/content/whatwg-url-parser-wanted-issue.png)

![WHATWG URL Parser Problem: C++ Bridge](@/assets/content/whatwg-url-parser-problem.png)

![WHATWG URL Parser Solution](@/assets/content/whatwg-url-parser-solution.png)

![Similar Studies](@/assets/content/whatwg-url-parser-similar-studies.png)
...
![Benchmark results](@/assets/content/whatwg-url-benchmark.png)
...
![Benchmark results](@/assets/content/whatwg-url-benchmark-results.png)
