  ...
  return (
    ...
    >
      {state.succeeded && !state.submitting && (
        <div className="bg-[#f6f6f6] dark:bg-[#2f333c] text-neutral-300 px-4 sm:px-6 py-2 rounded-md text-sm flex flex-col sm:flex-row sm:gap-x-2">
