...
date: '2023-01-13T14:31:27.000+00:00'
tag: tags/coding.mdx
status: published
type: Blog
minute_to_read: 2
...
* Not all parameter and return types are supported in fast API calls. For a full list, please look into [v8-fast-api-calls.h](https://source.chromium.org/chromium/chromium/src/+/main:v8/include/v8-fast-api-calls.h?ref=yagiz.co).
