...
date: '2021-10-15T17:28:09.000+00:00'
...
![](https://www.yagiz.co/content/images/2021/10/1-B87VusyxVmV0WOdUybWKpg.png)
...
The following algorithm is an example of Breadth first search algorithm where each node has a validity and inserted into the tree according to the rule. For more information about the algorithm please look into the [Wikipedia article](https://en.wikipedia.org/wiki/Breadth-first%5Fsearch?ref=yagiz.co).
...
![](https://lh4.googleusercontent.com/k_dt7Ly-bzSbUxep6L1pFv_SPu3uKfqMjrJkqCIrSvzSWK93rOxf8D0ohGer46VCClXLzpBGjtY-OQNKiF_dp94dAOOL4xhRKgU-XL8ZMU2_5Jnb2jJbG6kYIevWT-5j1XIXOvaI=s0)
